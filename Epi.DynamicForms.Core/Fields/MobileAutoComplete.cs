...
namespace MvcDynamicForms.Fields
{
    ...
    /// </summary>
    [Serializable]
    public class MobileAutoComplete : TextField
    {
        /// <summary>
        ...
        public override string RenderHtml()
        {
            ...
            //StyleValues.Append(GetControlStyle(_fontstyle.ToString(), _Prompttop.ToString(), "18px", null, Height.ToString(), _IsHidden));
           ...
           // input.Attributes.Add("style", "position:absolute;top:" + _top.ToString() + "px" + ";width:" + _ControlWidth.ToString() + "px ; font-size:" + ControlFontSize + "pt;" + ErrorStyle + ";" + IsHiddenStyle + ";" + IsHighlightedStyle + ";" + InputFieldStyle);
